...
function hungryDog(weight, age){
    ...
    else if (age >= 1 && weight === 11 || weight === 12 || weight === 13 || weight === 14 || weight === 15 ){
      return weight*.03
    }
    else if (age >= 1 && weight === 6||weight === 7||weight === 8||weight === 9||weight === 10){
      return weight*.04
    }
    else if (age >= 1 && weight <= 5){
      return weight*.05
    }
    else if (age === .166666666666 || age === .25){
      return weight*.1
    }
    else if (age === .33333333333333 || age === .416666666666 || age === .5){
      return weight*.05
    }
    else{
      return weight*.04
...
function game(user, computer){
    ...
    else if (computer >= .67 || computer <= 1){
      computer = 'scissors';
    }
